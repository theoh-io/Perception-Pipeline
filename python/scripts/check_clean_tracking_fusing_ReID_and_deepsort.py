...
if __name__ == "__main__":
    ...
    verbose = False #FIXME Change that

    pif_yolo_detector = custom_detectors.PifPafYOLODetector()
    ds_reid_tracker = custom_trackers.Custom_ReID_with_Deepsort()
    ...
    detector = final_detector.DetectorG16()
