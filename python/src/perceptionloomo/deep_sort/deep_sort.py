...
import os
from perceptionloomo.deep_sort.custom_feature_extractor import CustomFeatureExtractor
    ...
    def __init__(self, model, device, max_dist=0.2, max_iou_distance=0.7, max_age=70, n_init=3, nn_budget=100):
        ...
        if is_model_in_factory(model):
            ...
            if is_model_type_in_model_path(model):
                ...
                path_ = os.getcwd()
                model_path = path_ + "/src/perceptionloomo/deep_sort/deep/checkpoint/" + model
