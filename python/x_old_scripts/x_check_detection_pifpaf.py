...
from dlav22.detectors import pose_detectors
...
if __name__ == "__main__":
    ...
    pifpafDetect = pose_detectors.PifPafDetector(verbose=VERBOSE)
    colDetect = pose_detectors.ColorDetector(verbose=VERBOSE,dim_img=(250,170))
    poseColFuseDetect = pose_detectors.PoseColorGuidedDetector(dim_img=(250,170))
